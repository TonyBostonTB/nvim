...
-- conceallevel set below for obsidian compatibility
vim.wo.signcolumn = 'yes'            -- Keep signcolumn on by default (default: 'auto')
vim.o.fileencoding = 'utf-8'         -- The encoding written to a file (default: 'utf-8')
vim.o.cmdheight = 0                  -- Hide command line when not used for cleaner UI (default: 1)
...
vim.opt.conceallevel = 1 -- needed for obsidian
